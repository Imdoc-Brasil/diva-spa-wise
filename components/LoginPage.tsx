                        ...
                        <form onSubmit={handleLogin} className="space-y-6 animate-slide-up">
                            ...
                            ${selectedRole === UserRole.ADMIN ? 'bg-diva-dark' :
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-diva-dark capitalize">
                                        {selectedRole === UserRole.CLIENT ? 'Paciente' :
                                            selectedRole === UserRole.STAFF ? 'Profissional' :
                                                selectedRole === UserRole.ADMIN ? 'Administrador' : selectedRole}
                                    </p>
                                </div>
                            </div>
                            ...
                            <p className="text-center text-xs text-gray-400 mt-6">
                                Ambiente Seguro • I'mDoc® OS v2.0
                            </p>
                        </form>
                    )}
                </div>
