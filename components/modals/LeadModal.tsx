...
const LeadModal: React.FC<LeadModalProps> = ({ isOpen, onClose, onSave, onDelete, initialData }) => {
                ...
                <div className="p-5 border-t border-gray-100 flex justify-end gap-2 bg-gray-50 shrink-0">
                    {initialData && onDelete && (
                        <button
                            ...
                            className="mr-auto px-4 py-2 text-sm font-bold text-red-500 hover:bg-red-50 rounded-lg transition-colors"
                        >
                            Excluir
                        </button>
                    )}
