...
import { ServiceAppointment, Client, SessionRecord } from '../../types';
import { X, Shield, Zap, FileText, Camera, CheckCircle, AlertTriangle, Save, Map, Plus, Trash2, Mic } from 'lucide-react';
        ...
        <div className="bg-diva-dark text-white p-6 flex justify-between items-start">
          <div>
            <div className="flex items-center gap-2 mb-1">
                <span className="bg-diva-accent text-white text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">Em Atendimento</span>
