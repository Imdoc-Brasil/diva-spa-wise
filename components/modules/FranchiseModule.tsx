...
const FranchiseModule: React.FC = () => {
    ...
    const totalClients = units.reduce((acc, u) => acc + u.activeClients, 0);
    const avgNps = Math.round(units.reduce((acc, u) => acc + u.nps, 0) / units.length);
                ...
                <div className="flex-1 bg-white rounded-xl border border-diva-light/30 shadow-sm flex flex-col overflow-hidden">
                    ...
                    <div className="flex-1 overflow-y-auto p-6">
                        <div className="space-y-4">
                            {units.sort((a, b) => b.revenue - a.revenue).map((unit, idx) => (
                ...
                <div className="w-full lg:w-1/3 flex flex-col gap-6">
                    ...
                    <div className="bg-diva-dark/5 p-6 rounded-xl border border-diva-dark/10 shadow-sm flex-1 flex flex-col relative overflow-hidden">
                        ...
                        <button
                            ...
                            className="w-full mt-4 bg-white border border-diva-dark text-diva-dark py-2 rounded-lg text-xs font-bold hover:bg-gray-50 transition-colors relative z-10"
                        >
