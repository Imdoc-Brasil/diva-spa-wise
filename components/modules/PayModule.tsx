                ...
                {activeTab === 'links' && (
                    <div className="space-y-6">
                        <div className="flex justify-between items-center">
                            ...
                            <button className="bg-diva-primary text-white px-4 py-2.5 rounded-lg text-sm font-bold flex items-center hover:bg-diva-dark shadow-md transition-colors">
                                ...
                                <div key={link.id} className="bg-white p-4 rounded-xl border border-diva-light/30 shadow-sm flex items-center justify-between hover:shadow-md transition-all">
                                    ...
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div className="flex gap-2">
                                            <button className="p-2 text-gray-400 hover:text-diva-primary hover:bg-gray-100 rounded-lg" title="Copiar Link">
                                                <Copy size={18} />
                                            </button>
                                            <button className="p-2 text-gray-400 hover:text-green-600 hover:bg-green-50 rounded-lg" title="Enviar WhatsApp">
                                                <Share2 size={18} />
                                            </button>
                                            {link.status === 'active' && (
