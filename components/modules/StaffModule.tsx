...
import { WorkShift, Kudo } from '../../types';
import { UserCheck, Star, Award, TrendingUp, Clock, MoreVertical, Shield, Calendar, Briefcase, Coffee, Sun, AlertCircle, Heart, Smile, Trophy, Medal } from 'lucide-react';
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <div key={member.id} className="bg-white rounded-xl shadow-sm border border-diva-light/30 overflow-hidden hover:shadow-md transition-shadow">
                    ...
                    <div className="p-6 border-b border-diva-light/20 flex justify-between items-start">
                        ...
                        <button className="text-gray-400 hover:text-diva-dark">
                ...
                {/* Add New Staff Card */}
                <div className="border-2 border-dashed border-diva-light/40 rounded-xl flex flex-col items-center justify-center p-8 text-gray-400 hover:border-diva-primary hover:text-diva-primary hover:bg-diva-primary/5 transition-all cursor-pointer min-h-[300px]">
