...
const ReportsModule: React.FC = () => {
  ...
  // Mock tax/variable cost logic for demo visualization (since transaction categories might be limited)
  const taxes = totalRevenue * 0.06; // Simples Nacional Approx
              ...
              <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl border border-diva-light/30 shadow-lg">
                  ...
                  <div className="space-y-1">
                      ...
                      <div className="flex justify-between items-center py-2">
                          <span className="font-bold text-gray-700">(=) Receita Bruta de Vendas</span>
                          <span className="font-mono font-bold text-diva-dark">{formatCurrency(totalRevenue)}</span>
                      </div>
                      <div className="flex justify-between items-center py-1 pl-4 text-sm text-gray-500">
                          <span>(-) Impostos Estimados (6%)</span>
                          <span className="font-mono text-red-400">({formatCurrency(taxes)})</span>
                      </div>
