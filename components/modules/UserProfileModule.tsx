...
const UserProfileModule: React.FC<UserProfileModuleProps> = ({ user, onLogout }) => {
  ...
  const handleToggle2FA = () => {
      ...
      addToast(preferences.twoFactorEnabled ? '2FA Desativado.' : '2FA Ativado com sucesso.', preferences.twoFactorEnabled ? 'warning' : 'success');
  };
        ...
        <div className="bg-white rounded-xl shadow-sm border border-diva-light/30 relative overflow-hidden shrink-0">
            ...
            <div className="px-8 pb-6 flex items-end gap-6 -mt-12">
                <div className="w-32 h-32 bg-white rounded-full border-4 border-white shadow-md flex items-center justify-center text-6xl font-bold text-diva-dark relative group">
                    ...
                    <button className="absolute bottom-0 right-0 bg-diva-primary text-white p-2 rounded-full shadow-sm hover:bg-diva-dark transition-colors">
                        <Camera size={16} />
                    </button>
                </div>
                        ...
                        <div>
                            ...
                            <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 space-y-6">
                                <div className="flex justify-between items-center">
                                    ...
                                    <button className="text-sm font-bold text-diva-primary border border-diva-primary px-4 py-2 rounded-lg hover:bg-diva-light/10">
                                        Redefinir
                                    </button>
                                </div>
                        ...
                        <div>
                            ...
                            <div className="bg-white border border-diva-light/30 rounded-xl p-6 space-y-4">
                                <div className="flex justify-between items-center">
                                    ...
                                    <input type="checkbox" checked={preferences.notifications.email} onChange={() => setPreferences(p => ({...p, notifications: {...p.notifications, email: !p.notifications.email}}))} className="accent-diva-primary w-5 h-5" />
                                </div>
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center gap-3">
                                    ...
                                    <input type="checkbox" checked={preferences.notifications.push} onChange={() => setPreferences(p => ({...p, notifications: {...p.notifications, push: !p.notifications.push}}))} className="accent-diva-primary w-5 h-5" />
                                </div>
                            </div>
                        </div>
