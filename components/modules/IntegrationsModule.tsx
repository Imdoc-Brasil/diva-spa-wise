                                ...
                                <div key={int.id} className="bg-white p-6 rounded-xl border border-diva-light/30 shadow-sm hover:shadow-md transition-all flex flex-col h-full">
                                    <div className="flex justify-between items-start mb-4">
                                        ...
                                        <div className={`flex items-center gap-1 px-2 py-1 rounded-full text-[10px] font-bold uppercase
                                            ...
                                            {int.connected ? <CheckCircle size={10} /> : <Power size={10} />}
                                    ...
                                    <div className="flex gap-3 mt-auto">
                                        <button 
                                            ...
                                            className={`flex-1 py-2 rounded-lg text-sm font-bold border transition-colors
                                                ${int.connected ? 'border-red-200 text-red-600 hover:bg-red-50' : 'bg-diva-primary text-white border-transparent hover:bg-diva-dark'}`}
                                        >
                                            {int.connected ? 'Desconectar' : 'Conectar'}
                                        </button>
                                        {int.connected && int.configRequired && (
            ...
            {activeTab === 'webhooks' && (
                <div className="flex-1 flex flex-col p-6 bg-gray-50">
                    ...
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button className="bg-diva-dark text-white px-4 py-2 rounded-lg text-sm font-bold flex items-center hover:bg-diva-primary">
