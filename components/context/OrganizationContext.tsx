                ...
                if (p?.organization_id) {
                    ...
                    if (os && os.length > 0) {
                        ...
                        const realOrgs: Organization[] = os.map(o => ({
                            ...
                            displayName: o.name,
                            type: 'clinic',
                            subscriptionPlanId: o.subscription_plan || 'professional',
                            subscriptionPlan: { id: o.subscription_plan || 'professional', name: o.subscription_plan || 'Profissional', tier: 'professional', pricing: { monthly: 597, yearly: 5970, currency: 'BRL' }, limits: { maxUnits: 3, maxUsers: 20, maxClients: 2000, maxStorage: 50 }, features: ['all'] },
                            subscriptionStatus: o.subscription_status || 'active',
                            subscriptionStartedAt: o.created_at,
